...
object DataStore : OnPreferenceDataStoreChangeListener {
    ...
    var dohServers by configurationStore.string(Key.DOH_SERVERS) { "" }

    var dohServersList by configurationStore.stringSet(Key.DOH_SERVERS_LIST) { setOf("https://cloudflare-dns.com/dns-query", "https://dns.google/dns-query", "https://dns.quad9.net/dns-query") }
